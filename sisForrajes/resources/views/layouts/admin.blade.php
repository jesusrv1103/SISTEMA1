...
<html>
  <head>
    ...
    <title>Sistema Forrajes | www.Smart-Line.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Sistema Forrajes</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Jesus Ramirez Vargas</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      www.Smart-Line.com - Desarrollo de Software
                      <small>www.ITZ.com</small>
                    </p>
                  </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2020 <a href="www.Smart-line.com">Smart-Line</a>.</strong> All rights reserved.
      </footer>
